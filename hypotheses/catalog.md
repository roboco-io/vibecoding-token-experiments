...
| M-14 | Claude Code를 Upstage Anthropic 호환 엔드포인트로 solar-pro4에 직결하면(thinking 기본값) 격리·무교란 랄프 루프로 RealWorld 백엔드를 상한 30 iter 안에 무개입 완주할 수 있다 (n=3, 완주율 판정·과금 배제. 선행 게이트: 2026-08-19 `/v1/messages` 복구·스모크 200 확인) | 진행중 (EXP-020) | [EXP-020](../experiments/020-solar-pro4-direct/README.md) |
