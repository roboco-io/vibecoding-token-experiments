...
| M-13 | EXP-015의 solar-open2 직결 무개입 완주는 재현된다 — 추가 2 run(총 n=3) 전부 30 iter 내 게이트(measure v4)+재검증 완주 (과금 배제 — 완주율 단일 판정, 순차 실행) | 진행중 (EXP-018) | [EXP-018](../experiments/018-solar-n3-replication/README.md) |
