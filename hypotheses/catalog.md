...
| L-02 | qwen3.8-max·kimi-k3(직결)는 한국어 정본 프롬프트(전 산출물 한국어 지시) 조건에서도 랄프 루프로 RealWorld 백엔드를 상한 30 iter 안에 무개입 완주할 수 있다 (각 n=3, 완주율 판정·과금 배제) | 진행중 | [EXP-017](../experiments/017-ko-condition/README.md) |
